...
namespace TOME.Map
{
    ...
    public class MapNode : MonoBehaviour
    {
        ...
        {
            if (!def) return;
            bool u = MapProgressionManager.I != null && MapProgressionManager.I.IsUnlocked(def);
            _btn.interactable = u;
        ...
        void OnClick()
        {
            if (!def || MapProgressionManager.I == null || !MapProgressionManager.I.IsUnlocked(def)) return;
