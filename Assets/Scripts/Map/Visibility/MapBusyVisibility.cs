...
namespace TOME.Map
{
    ...
    public class MapBusyVisibility : MonoBehaviour
    {
        ...
        void ApplyHighlights(bool busy)
        {
            ...
            {
                foreach (var h in Object.FindObjectsByType<SpriteHighlight>(FindObjectsInactive.Include))
                {
                    if (h == null) continue;
        ...
        void Hide()
        {
            ...
            CollectAndHide<TOME.Dialogue.HideDuringDialogue>();   // 인벤토리·조합 진입 UI 등, 씬에서 표시해 둔 것들
        ...
        {
            var arr = Object.FindObjectsByType<T>(FindObjectsInactive.Exclude);
