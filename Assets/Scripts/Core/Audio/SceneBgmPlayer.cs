...
namespace TOME.Core
{
    ...
    public class SceneBgmPlayer : MonoBehaviour
    {
        ...
        void Start()
        {
            ...
            {
                var stage = TOME.Managers.GameManager.I != null ? TOME.Managers.GameManager.I.CurrentStage : null;
                if (stage != null && stage.bgm != null) toPlay = stage.bgm;   // 스테이지 전용 BGM 우선
            }
            else if (useCurrentChapterBgm)
            {
                var chapter = TOME.Managers.GameManager.I != null ? TOME.Managers.GameManager.I.CurrentChapter : null;
